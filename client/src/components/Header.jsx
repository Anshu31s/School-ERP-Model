...
const Header = () => {
    ...
    return (
        <>
            <header className="w-[81%] fixed z-10 bg-gray-900 flex justify-between md:justify-end items-center p-2 px-4">
                <button className='text-white block md:hidden'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 -0.5 25 25" fill="currentcolor">
