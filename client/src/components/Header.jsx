...
import { getUser, logoutUser } from './utils/authActions';
...
const Header = ({ toggleSidebar }) => {
    ...
    return (
        <>
            <header className="w-full top-0 xl:w-[85%] fixed z-10 bg-gray-900 flex justify-between xl:justify-end items-center p-2 px-4">
                <button onClick={ toggleSidebar } className='text-white block xl:hidden'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0.5 24 24" fill="currentcolor">
                ...
                <div className='flex items-center'>
                    <div className="relative mr-6 text-gray-600 dark:text-gray-300">
                        <svg
