...
const Sidebar = ({ showSidebar }) => {
  ...
  return (
    <>
      <div className="md:max-lg:fixed md:max-lg:inset-0 md:max-lg:bg-black md:max-lg:bg-opacity-50 ">
        <div className="flex z-10 fixed top-0 left-0 sm:z-10 flex-col mt-10 md:mt-0 xl:w-[15%] h-screen px-5 py-8 overflow-y-auto bg-white dark:bg-gray-900 dark:border-gray-700 shadow-lg shadow-black">
