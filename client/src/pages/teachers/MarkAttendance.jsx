import GetStudents from "../../hooks/Viewstudents";
...
const UploadAttendance = () => {
  ...
  const { students, loading, error } = GetStudents(selectedClass);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/protected/upload-attendace",
        payload,
        {
          headers: {
  ...
  return (
    <div>
      <form
        ...
        className="bg-white w-full p-2 h-screen rounded shadow-md"
      >
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          {(selectedClass === "11" || selectedClass === "12") && (
            <div className="flex-1">
              <label htmlFor="stream" className="block mb-2 font-medium">
                Stream:
              </label>
              <select
                id="stream"
                    ...
                    >
                      ...
                      <td className="p-2">
                        <input
                          ...
                          value="present"
                          onChange={() =>
                            handleAttendanceChange(student.userId, "present")
                          }
                      ...
                      <td className="p-2">
                        <input
                          ...
                          value="absent"
                          onChange={() =>
                            handleAttendanceChange(student.userId, "absent")
                          }
                      ...
                      <td className="p-2">
                        <input
                          ...
                          value="na"
                          onChange={() =>
                            handleAttendanceChange(student.userId, "na")
                          }
                      ...
                      <td className="p-2">
                        <input
                          ...
                          value="leave"
                          onChange={() =>
                            handleAttendanceChange(student.userId, "leave")
                          }
